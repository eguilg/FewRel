...
| GNN(CNN) 422k      | 71.46 | 80.54 | 56.10 | 64.02 |
| GNN-dot(CNN) 57k     | 72.70 | 84.08 | 57.58 | 71.31 | 
...
| WGNN-rmQK(CNN)    | 79.74 | 87.20 | 64.94 | 76.30 |
| MetaWGNN-rmQK(CNN)+INCON| 80.52 | 88.89 | 65.04 | 77.42 | 
| MetaWGNN(RNN)     | 80.52 | 88.54 | 67.07 | 78.97 |
| MetaWGNN(RNN)+INCON| 80.52 | 89.42 | 67.07 | 79.13 |  
| MetaWGNN-rmQK(RNN)+INCON| - | 89.41 | - | - |
| MetaWGNN-rmQK(SMALLBERT)+INCON| **88.69** | **92.88** | 77.48 | 85.57 |  
...
| WGNN | 728526 |
| METAWGNN(add) |  728526 |
| METAWGNN(cat) |  2122450 |

##1. Experiment on num heads
|     GAPN(CNN)          | 5 way 1 shot | 5 way 5 shot | 10 way 1 shot | 10 way 5 shot |
|  ---------------  | -----------  | ------------- | ------------ | ------------- |
| H=1      | 77.32 | 86.53 | 64.31 | 75.84 |
| H=2      | 77.52 | 86.60 | 64.32 | **76.56** | 
| H=4      | 78.79 | 86.79 | 64.91 | 76.00 | 
| H=8      | 79.94 | 87.26 | **65.12** | 75.88 |
| H=12     | 79.59| 87.20 | 64.81 | 75.16 |
| H=16     | **80.20** | **87.27** | 63.58 | 75.42 | 
| H=20     | 79.96 | 86.84 | 64.21 | 75.40 |
| H=30     | 78.60 | 86.72 | 63.67 | 74.27 |

##2. Experiment on GAPN and other models
|      FewRel 1.0          | 5 way 1 shot | 5 way 5 shot | 10 way 1 shot | 10 way 5 shot |
|  ---------------  | -----------  | ------------- | ------------ | ------------- |
| MAML(CNN)      | 66.80 | 80.73 | 47.87 | 64.09 | 
| GNN(CNN) 422k      | 71.46 | 80.54 | 56.10 | 66.99 |
| GNN-dot(CNN)57k     | 72.70 | 84.08 | 57.58 | 71.31 | 
| Proto(CNN)        | 63.73 | 84.84 | 58.31 | 74.72 |
| GAPN(CNN)        | 80.20 | 87.27 | 65.12 | 76.56 |
| MGAPN(CNN)        | **80.52** | 89.02 | **66.30** | 78.41 |
| MGAPN(CNN)+INCON  | - | **89.42** | - | **79.25** | 
|  ---------------  | -----------  | ------------- | ------------ | ------------- |
| BERT-PAIR| 85.66 | 89.48 | 76.84 | 81.76 |
| MGAPN(bert-small)+INCON| **88.69** | **92.92** | **77.48** | **85.57** |
...
|  ---------------  | -----------  | ------------- | ------------ | ------------- |
| Proto(CNN)        | - | - | - | - |
| Proto-ADV(CNN)    | 48.73 | 64.38 | 34.82 | 50.39 |
| GNN(CNN)          | 35.91 | 44.75 | 22.89 | - |
| GNN-ADV(CNN)      | 46.39 | 61.14 | 30.27 | 48.70 | 
| GAPN(CNN)         | 38.09 | 46.90 | 24.51 | 31.95 | 
| GAPN-ADV(CNN)     | 51.42 | 61.96 | 40.39 | 51.79 |
| MGAPN-ADV(CNN)     | 52.04 | 65.20 | 41.24 | 54.65 |
| MGAPN-ADV(CNN)+INCON| **52.04** | **65.84** | **41.24** | **54.94** |


##4. NOTA
|    FewRel 2.0 NOTA   | NOTA 15% 5-way-1-shot | NOTA 15%  5-way-5-shot | NOTA 50% 5-way-1-shot | NOTA 50% 5-way-5-shot |
|  ---------------  | -----------  | ------------- | ------------ | ------------- |
| Proto(CNN)| 60.79 | 70.57 | 50.21 | 62.28 |
| GNN(CNN)| 62.93 | 72.24 | 62.63 | 68.68 |
| MAML(CNN)| 55.47 | 68.66 | 56.12 | 62.91 |
| GAPN(CNN)| 68.97 | 76.75 | 69.11 | 75.80 |
| MGAPN(CNN)| 70.11 | 77.03 | 69.66 | 76.40 |
| MGAPN(CNN)+INCON| 70.14 | 77.50 | 69.76 | 76.88|
|  ---------------  | -----------  | ------------- | ------------ | ------------- |
| BERT-PAIR| 74.56 | 73.09 | 75.01 | 75.38 |
| MGAPN(bert-mini)+INCON| 76.77 | 83.11 | 74.14 | **78.44** |
| MGAPN(bert-small)+INCON| **79.70** | **83.14** | **77.31** | **78.51** |
